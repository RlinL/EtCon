...
@dataclass
class TrainableComponentsConfig:
    """Configuration for fine-grained trainable component control
    
    Supported components:
    - Layer-level: ["mlp", "self_attn", "input_layernorm", "post_attention_layernorm"]  
...
class ModelConfig:
    ...
    trainable_components: Optional[TrainableComponentsConfig] = None
